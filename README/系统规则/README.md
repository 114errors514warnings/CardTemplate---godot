...
| [六边形战场玩法](战斗系统/六边形战场玩法.md) | 战场坐标、单位射程、攻击范围、移动、装备槽、战场物件与多种关卡目标 |
...
| [地图玩法数值设计](地图玩法/地图玩法数值设计.md) | 第一层通关流程数值（k=7 几何 / 13 非特殊格点 / 敌方档位 / 成长曲线 / 逐节点演算）|
...
| 文档 | 范围 |
|------|------|
| [六边形战场交互](界面交互/战斗/六边形战场交互.md) | 战场浏览、移动、卡牌范围、敌方意图、装备、临时道具、目标栏与结算交互 |
